package com.example.techtree.domain.koreaInvesment.controller;

import com.example.techtree.domain.koreaInvesment.model.IndexData;
import com.example.techtree.domain.koreaInvesment.model.Invesment;
...
public class KisController {
    ...
    public String majorIndices(Model model) {
        List<Tuple2<String, String>> iscdsAndOtherVariable1 =
                Arrays.asList(
                        Tuples.of("0001", "U"),
                        Tuples.of("2001", "U"),
                        Tuples.of("1001", "U")
        ...
        Flux<IndexData> indicesFlux = Flux.fromIterable(iscdsAndOtherVariable1)
                ...
                .map(jsonData -> {
                    ...
                    try {
                        return
                                objectMapper.readValue(jsonData, IndexData.class);
    ...
    public Mono<String> CurrentPrice(@PathVariable("id") String id, Model model) {
        String url = KisConfig.REST_BASE_URL +
                "/uapi/domestic-stock/v1/quotations/inquire-price?fid_cond_mrkt_div_code=J&fid_input_iscd=" + id;
