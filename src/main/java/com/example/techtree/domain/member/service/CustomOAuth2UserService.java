...
public class CustomOAuth2UserService implements OAuth2UserService<OAuth2UserRequest, OAuth2User> {
    ...
    public OAuth2User loadUser(OAuth2UserRequest userRequest) throws OAuth2AuthenticationException {
        ...
        return new DefaultOAuth2User(
                Collections.singleton(new SimpleGrantedAuthority(
                        member.getAuthorities().toString())), attributes.getAttributes(), attributes.getNameAttributeKey()
        );
    ...
    private Member saveOrUpdate(OAuthAttributes attributes) {
        ...
        System.out.println("attributes = " + attributes.getName() + " 슬래쉬 " + attributes.getPicture() + " 슬래쉬 " + attributes.getEmail());
        System.out.println("member = " + member.getUsername() + " 슬래쉬 " + member.getProfileImage() + " 슬래쉬 " + member.getEmail());
